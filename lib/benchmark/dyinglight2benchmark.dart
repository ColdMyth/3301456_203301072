...
class Dyinglight2benchmark extends StatefulWidget {
  const Dyinglight2benchmark({Key? key}) : super(key: key);

  @override
  State<Dyinglight2benchmark> createState() => _Dyinglight2benchmark();
}

class _Dyinglight2benchmark extends State<Dyinglight2benchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://steamuserimages-a.akamaihd.net/ugc/796490743071012179/BEC4B20C37B5EEB67F310969130BD3D2AF062457/',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

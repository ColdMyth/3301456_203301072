...
class Skyrimbenchmark extends StatefulWidget {
  const Skyrimbenchmark({Key? key}) : super(key: key);

  @override
  State<Skyrimbenchmark> createState() => _Skyrimbenchmark();
}

class _Skyrimbenchmark extends State<Skyrimbenchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://i.pinimg.com/originals/4e/e9/2e/4ee92efa37f9fce197c340a008c7752e.gif',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

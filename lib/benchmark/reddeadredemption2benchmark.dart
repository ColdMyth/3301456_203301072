...
class Reddeadredemption2benchmark extends StatefulWidget {
  const Reddeadredemption2benchmark({Key? key}) : super(key: key);

  @override
  State<Reddeadredemption2benchmark> createState() =>
      _Reddeadredemption2benchmark();
}

class _Reddeadredemption2benchmark extends State<Reddeadredemption2benchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://media3.giphy.com/media/1gCTaoFeCpFTTCi9Jy/giphy.gif',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

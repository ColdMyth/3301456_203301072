...
class Acvalhallabenchmark extends StatefulWidget {
  const Acvalhallabenchmark({Key? key}) : super(key: key);

  @override
  State<Acvalhallabenchmark> createState() => _Acvalhallabenchmark();
}

class _Acvalhallabenchmark extends State<Acvalhallabenchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://media4.giphy.com/media/LnoZbGG0mkSdhO6kEa/giphy.gif?cid=790b761160de76153656f07b8ee9ac39249c41896f64838d&rid=giphy.gif&ct=g',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

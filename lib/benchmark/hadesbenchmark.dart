...
class Hadesbenchmark extends StatefulWidget {
  const Hadesbenchmark({Key? key}) : super(key: key);

  @override
  State<Hadesbenchmark> createState() => _Hadesbenchmark();
}

class _Hadesbenchmark extends State<Hadesbenchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://64.media.tumblr.com/7b20db0389e8269cab765d61012645ef/42281425f327b426-af/s540x810/6f863288acd67ac3aa821cb7c65a9e629070c94f.gifv',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

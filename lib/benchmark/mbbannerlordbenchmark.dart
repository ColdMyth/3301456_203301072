...
class Mbbannerlordbenchmark extends StatefulWidget {
  const Mbbannerlordbenchmark({Key? key}) : super(key: key);

  @override
  State<Mbbannerlordbenchmark> createState() => _Mbbannerlordbenchmark();
}

class _Mbbannerlordbenchmark extends State<Mbbannerlordbenchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://c.tenor.com/evWGGfsPZp4AAAAd/bannerlord-animation-bannerlord.gif',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

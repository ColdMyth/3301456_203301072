...
class Forzahorizon4benchmark extends StatefulWidget {
  const Forzahorizon4benchmark({Key? key}) : super(key: key);

  @override
  State<Forzahorizon4benchmark> createState() => _Forzahorizon4benchmark();
}

class _Forzahorizon4benchmark extends State<Forzahorizon4benchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://thumbs.gfycat.com/DisguisedHomelyIndri-size_restricted.gif',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

...
class Cyberpunk2077benchmark extends StatefulWidget {
  const Cyberpunk2077benchmark({Key? key}) : super(key: key);

  @override
  State<Cyberpunk2077benchmark> createState() => _Cyberpunk2077benchmark();
}

class _Cyberpunk2077benchmark extends State<Cyberpunk2077benchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://i.pinimg.com/originals/8b/bd/30/8bbd300c6ce8e7cef45f107de46a7fdc.gif',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

...
class Forzahorizon5benchmark extends StatefulWidget {
  const Forzahorizon5benchmark({Key? key}) : super(key: key);

  @override
  State<Forzahorizon5benchmark> createState() => _Forzahorizon5benchmark();
}

class _Forzahorizon5benchmark extends State<Forzahorizon5benchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://media1.giphy.com/media/VgvLyXeQ35gGhzmcVG/giphy-downsized-large.gif',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

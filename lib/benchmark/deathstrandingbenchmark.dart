...
class Deathstrandingbenchmark extends StatefulWidget {
  const Deathstrandingbenchmark({Key? key}) : super(key: key);

  @override
  State<Deathstrandingbenchmark> createState() => _Deathstrandingbenchmark();
}

class _Deathstrandingbenchmark extends State<Deathstrandingbenchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://c.tenor.com/lv-fpVGVc9kAAAAd/death-stranding.gif',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

...
class Apexlegendsbenchmark extends StatefulWidget {
  const Apexlegendsbenchmark({Key? key}) : super(key: key);

  @override
  State<Apexlegendsbenchmark> createState() => _Apexlegendsbenchmark();
}

class _Apexlegendsbenchmark extends State<Apexlegendsbenchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://www.icegif.com/wp-content/uploads/2022/03/icegif-307.gif',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

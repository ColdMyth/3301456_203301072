...
class Csgobenchmark extends StatefulWidget {
  const Csgobenchmark({Key? key}) : super(key: key);

  @override
  State<Csgobenchmark> createState() => _Csgobenchmark();
}

class _Csgobenchmark extends State<Csgobenchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://c.tenor.com/wP9svZId2dcAAAAC/csgo-lmao.gif',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),

...
class Thewitcher3benchmark extends StatefulWidget {
  const Thewitcher3benchmark({Key? key}) : super(key: key);

  @override
  State<Thewitcher3benchmark> createState() => _Thewitcher3benchmarkState();
}

class _Thewitcher3benchmarkState extends State<Thewitcher3benchmark> {
  @override
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            ClipRRect(
              child: Image.network(
                'https://thumbs.gfycat.com/OblongDisguisedHarpseal-size_restricted.gif',
                width: 390,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),
          ...
          children: [
            ...
            Center(
              child: Container(
                child: const Center(
                  child: Text(
                    "Daha fazla fps değeri için lütfen sisteminizi geliştirin.",
                    style: TextStyle(
                      fontFamily: "Oswald",
                      fontSize: 32,
                      color: Color(0xFFddffff),
